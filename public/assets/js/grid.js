...
export class Grid {
  ...
  DOM = {
    ...
    //remove-button
    filter: document.querySelector(".remove-button"),
    // .content__nav
      ...
      gridItem.DOM.img.outer.addEventListener("mouseenter", () => {
        ...
        gsap
          ...
          .to(
            ...
            { ease: "power4", scaleY: 1.4, scaleX: 1.5 },
            "start"
          );
      });
  ...
  showContent(gridItem) {
    ...
    for (const [
      ...
      this.timeline
        .to(
          [viewportGridItem.DOM.caption, gridItem.DOM.caption, this.DOM.filter],
          {
            ease: "expo",
  ...
  closeContent() {
    ...
    gsap
      ...
      .to(
        [this.viewportGridItem.DOM.caption, gridItem.DOM.caption],
        {
          opacity: 1,
        },
        "showGrid"
